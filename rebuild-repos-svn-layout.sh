...
rm -fr $workdir/$git_bare_subdir # will delete previous work, you may commment out!
rm -fr $workdir/$git_test_subdir # will delete previous work, you may commment out!
...
git svn clone $svnbase/$project --no-metadata --stdlayout -A $scriptdir/authors $workdir/$svn_clone_subdir/$project$svn_clone_extension
